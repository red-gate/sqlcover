...
function global:RestoreBuildLevelPackages {
    Write-Host "Root path for PSSCRIPT - $PsScriptRoot"
    # Download paket.exe.
...
function global:Build {
    ...
    try
    {
      ...
      #Import-Module '.\packages\RedGate.Build.DependencyCheck\tools\RedGate.Build.DependencyCheck.psm1' -Force -DisableNameChecking
...
Write-Host "This is the SQLCover repo. And here are the available commands:" -Fore Magenta
